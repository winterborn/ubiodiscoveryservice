...
describe("InstanceRepository", () => {
    ...
    it("should create or update an instance", async () => {
        const instance = await instanceRepo.createOrUpdateInstance("test-group", "instance-1", { updatedAt: Date.now(), meta: { key: "value" } });
    ...
    it("should find an existing instance", async () => {
        ...
        const instance = await instanceRepo.findInstance("test-group", "instance-1");
    ...
    it("should delete an instance", async () => {
        ...
        const deleted = await instanceRepo.deleteInstance("test-group", "instance-1");
...
//# sourceMappingURL=InstanceRepository.test.js.map